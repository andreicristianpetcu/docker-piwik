...
--
-- Table structure for table `piwik_archive_blob_2014_11`
--

DROP TABLE IF EXISTS `piwik_archive_blob_2014_11`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `piwik_archive_blob_2014_11` (
...
--
-- Dumping data for table `piwik_archive_blob_2014_11`
--

LOCK TABLES `piwik_archive_blob_2014_11` WRITE;
/*!40000 ALTER TABLE `piwik_archive_blob_2014_11` DISABLE KEYS */;
/*!40000 ALTER TABLE `piwik_archive_blob_2014_11` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `piwik_archive_numeric_2014_11`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `piwik_archive_numeric_2014_11` (
  `idarchive` int(10) unsigned NOT NULL,
  `name` varchar(255) NOT NULL,
  `idsite` int(10) unsigned DEFAULT NULL,
  `date1` date DEFAULT NULL,
...
--
-- Dumping data for table `piwik_archive_numeric_2014_11`
--

LOCK TABLES `piwik_archive_numeric_2014_11` WRITE;
/*!40000 ALTER TABLE `piwik_archive_numeric_2014_11` DISABLE KEYS */;
INSERT INTO `piwik_archive_numeric_2014_11` VALUES (1,'done',1,'2014-11-21','2014-11-21',1,'2014-11-22 01:11:34',1),(2,'done',1,'2014-11-22','2014-11-22',1,'2014-11-22 01:11:34',3),(3,'donefea44bece172bc9696ae57c26888bf8a.VisitsSummary',1,'2014-11-21','2014-11-21',1,'2014-11-22 01:11:36',1),(4,'donefea44bece172bc9696ae57c26888bf8a.VisitsSummary',1,'2014-11-22','2014-11-22',1,'2014-11-22 01:11:36',3);
/*!40000 ALTER TABLE `piwik_archive_numeric_2014_11` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `piwik_sequence` VALUES ('piwik_archive_numeric_2014_11',4);
...
INSERT INTO `piwik_site` VALUES (1,'onoratainstanta','http://onoratainstanta.ro','2014-11-22 01:10:35',0,1,'','','Europe/Bucharest','USD','','','','','website',0);
...
INSERT INTO `piwik_user` VALUES ('andrei','05a671c66aefea124cc08b76ea6d30bb','andrei','andrei@ceata.org','c748fdb9a23717a09062b8bc9dc11e9f',1,'2014-11-22 01:10:10'),('anonymous','','anonymous','anonymous@example.org','anonymous',0,'2014-11-22 01:09:26');
...
-- Dump completed on 2014-11-22  1:24:47
